...
class EventForm extends React.Component {
        ...
        this.setState(
          {
            ...
            start_datetime: {
              valid: true,
              value: new Date(response.data.start_datetime).toDateString(),
            },
          },
          this.validateForm
        );
  ...
  handleInput = (e) => {
    ...
    this.setState(newState, () =>
      this.validateField(name, value, EventForm.formValidations[name])
    );
  };
  ...
  handleSubmit = (e) => {
    ...
    const url = this.state.editing
      ? `http://localhost:3001/events/${this.props.match.params.id}`
    ...
    return (
      <div>
        ...
        <form onSubmit={this.handleSubmit}>
          ...
          <input
            type="submit"
            value={this.state.editing ? "Update Event" : "Create Event"}
